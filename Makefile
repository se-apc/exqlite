...
CFLAGS += -DSQLITE_DEFAULT_WAL_SYNCHRONOUS=3
# -DSQLITE_OMIT_DEPRECATED=1
# CFLAGS += -DSQLITE_OMIT_SHARED_CACHE=1
CFLAGS += -DSQLITE_OMIT_SHARED_CACHE
# -DSQLITE_ENABLE_COLUMN_METADATA=1
CFLAGS += -DSQLITE_DISABLE_FTS3
# -DSQLITE_ENABLE_LOCKING_STYLE=POSIX
